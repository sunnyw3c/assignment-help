                    ...
                    <div class="relative z-10">
                        ...
                        <div class="p-8">
                            ...
                            <div class="flex gap-3">
                                <a href="{{ route('assignment-services.show', $service->slug) }}" class="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-900 py-3 rounded-xl font-semibold transition-all duration-300 flex items-center justify-center group/learn">
                                    Learn More
