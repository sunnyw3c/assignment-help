...
@section('title', 'Nursing Homework Essay Help | Vetted Healthcare Writing')
@section('description', 'Struggling with nursing care plans, clinical reports, anatomy charts, or healthcare essays? Get professional nursing homework essay help.')
...
@section('content')
    <div class="min-h-screen bg-slate-50 dark:bg-slate-950">
        ...
        <x-creative-hero 
            :service="$service" 
            title="Nursing Homework Essay Help" 
            subtitle="Struggling with nursing care plans (NCPs), pharmacology dosage formulas, anatomy case studies, or healthcare policy research? Get original, well-cited writing assistance from qualified medical tutors." 
        />
            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex flex-wrap items-center justify-center gap-x-10 gap-y-4">
                    <div class="flex items-center gap-2.5">
                        ...
                        <span class="text-xs text-slate-500 dark:text-slate-400">from 1,800+ nursing reviews</span>
                    </div>
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-xs font-semibold text-slate-700 dark:text-slate-300"><strong class="text-slate-900 dark:text-white">12</strong> Healthcare Tutors Online</span>
                    </div>
                    <div class="hidden h-5 w-px bg-slate-200 sm:block dark:bg-slate-700"></div>
                    <div class="flex items-center gap-2">
                        <svg class="h-4 w-4 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>
                        <span class="text-xs font-semibold text-slate-700 dark:text-slate-300">Turnitin Originality Reports Included</span>
                    </div>
                </div>
            </div>
        </section>
        ...
        {{-- ===================================================
             SECTION 2 – CONTENT — 2.5rem ROUNDED CARD PATTERN
        =================================================== --}}
        <section class="py-16 sm:py-20 bg-slate-50 relative overflow-hidden dark:bg-slate-950" id="nursing-details">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                <div class="mx-auto max-w-3xl text-center mb-24">
                    ...
                    <h2 class="text-4xl sm:text-6xl font-black tracking-tight text-slate-900 mb-8 leading-tight dark:text-white">
                        Nursing Homework <br>
                        <span class="text-blue-600">Essay Help</span>
                    </h2>
                    <p class="text-xl leading-relaxed text-slate-600 max-w-2xl mx-auto dark:text-slate-400">
                        Struggling with nursing care plans (NCPs), pharmacology dosage formulas, anatomy case studies, or healthcare policy research? Get original, well-cited writing assistance from qualified medical tutors.
                    </p>
                </div>

                <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-8 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                    
                    <!-- Card 1: Why Need Nursing Essay Help -->
                    <article class="flex flex-col bg-slate-50 rounded-[2.5rem] p-10 relative overflow-hidden group transition-all duration-500 hover:bg-white hover:shadow-[0_40px_80px_-20px_rgba(37,99,235,0.15)] hover:-translate-y-2 border border-slate-100 dark:bg-slate-950 dark:hover:bg-slate-800/50 dark:border-slate-800/80">
                        ...
                        <div class="flex items-center gap-5 mb-8 relative">
                            ...
                            <div>
                                <h3 class="text-xl font-black text-slate-900 tracking-tight dark:text-white">Professional Nursing Essay Help</h3>
                            </div>
                        </div>
                        <p class="text-sm leading-relaxed text-slate-500 mb-8 font-medium dark:text-slate-500">
                            Nursing curricula require a blend of clinical practice knowledge, science, and research formatting. Students are frequently tasked with writing detailed Nursing Care Plans (NCPs), pharmacology calculations, and essays examining healthcare policies. These tasks demand evidence-based references, correct medical terminology, and strict compliance with APA formatting. Our nursing homework essay help connects you with tutors holding degrees in nursing and healthcare sciences.
                        </p>
                    </article>

                    <!-- Card 2: Fields Covered -->
                    <article class="flex flex-col bg-slate-50 rounded-[2.5rem] p-10 relative overflow-hidden group transition-all duration-500 hover:bg-white hover:shadow-[0_40px_80px_-20px_rgba(16,185,129,0.15)] hover:-translate-y-2 border border-slate-100 dark:bg-slate-950 dark:hover:bg-slate-800/50 dark:border-slate-800/80">
                        ...
                        <div class="flex items-center gap-5 mb-8 relative">
                            ...
                            <div>
                                <h3 class="text-xl font-black text-slate-900 tracking-tight dark:text-white">Healthcare Fields Covered</h3>
                            </div>
                        </div>
                        <ul role="list" class="mb-10 space-y-4 text-sm text-slate-600 dark:text-slate-400">
                            <li class="flex items-center gap-3 font-bold group/item">
                                ...
                                Nursing Care Plans (NCPs) (NANDA diagnostic systems)
                            </li>
                            <li class="flex items-center gap-3 font-bold group/item">
                                <div class="w-5 h-5 rounded-md bg-emerald-50 flex items-center justify-center text-emerald-600 group-hover/item:bg-emerald-600 group-hover/item:text-white transition-all dark:bg-emerald-950/30">
                                    <svg class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7" /></svg>
                                </div>
                                Pharmacology Calculations &amp; Dosages reports
                            </li>
                            <li class="flex items-center gap-3 font-bold group/item">
                                <div class="w-5 h-5 rounded-md bg-emerald-50 flex items-center justify-center text-emerald-600 group-hover/item:bg-emerald-600 group-hover/item:text-white transition-all dark:bg-emerald-950/30">
                                    <svg class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7" /></svg>
                                </div>
                                Anatomy, Physiology, &amp; Healthcare Policy essays
                            </li>
                        </ul>
                    </article>
                </div>
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 relative max-w-7xl mx-auto">
                    ...
                    <div class="group relative">
                        ...
                        <div class="relative h-full bg-slate-800/50 backdrop-blur-xl border border-white/10 rounded-3xl p-8 overflow-hidden hover:-translate-y-2 transition-transform duration-500">
                            ...
                            <p class="text-sm leading-relaxed text-slate-400 relative z-10">Submit nursing care files details, citation guidelines, and deadline urgencies.</p>
                        </div>
                    </div>
                    ...
                    <div class="group relative">
                        ...
                        <div class="relative h-full bg-slate-800/50 backdrop-blur-xl border border-white/10 rounded-3xl p-8 overflow-hidden hover:-translate-y-2 transition-transform duration-500">
                            ...
                            <p class="text-sm leading-relaxed text-slate-400 relative z-10">A vetted healthcare expert reviews guidelines and sets a quote.</p>
                        </div>
                    </div>
                    ...
                    <div class="group relative">
                        ...
                        <div class="relative h-full bg-slate-800/50 backdrop-blur-xl border border-white/10 rounded-3xl p-8 overflow-hidden hover:-translate-y-2 transition-transform duration-500">
                            ...
                            <h3 class="text-2xl font-bold text-white mb-4 relative z-10">Tutor Writes Essay</h3>
                            <p class="text-sm leading-relaxed text-slate-400 relative z-10">The writer drafts evidence-based paragraphs, citations, and care diagnostics.</p>
                        </div>
                    </div>
                    ...
                    <div class="group relative">
                        ...
                        <div class="relative h-full bg-slate-800/50 backdrop-blur-xl border border-white/10 rounded-3xl p-8 overflow-hidden hover:-translate-y-2 transition-transform duration-500">
                            ...
                            <p class="text-sm leading-relaxed text-slate-400 relative z-10">Download Turnitin originality reports and learn from reference files layouts.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div class="max-w-4xl mx-auto text-center mb-12 lg:mb-16">
                    <h2 class="text-4xl md:text-5xl lg:text-6xl font-black text-slate-900 mb-6 tracking-tight dark:text-white">
                        Nursing Essay <span class="text-blue-600 dark:text-blue-400">FAQs</span>
                    </h2>
                </div>
                ...
                <div class="max-w-4xl mx-auto space-y-4">
                    <div x-data="{ open: false }" class="group bg-white border border-slate-200 rounded-[2rem] overflow-hidden transition-all duration-500 hover:border-blue-300 hover:shadow-xl dark:bg-slate-900 dark:border-slate-800/80">
                        <button x-on:click="open = !open" class="w-full px-10 py-8 flex items-center justify-between text-left focus:outline-none">
                            <span class="text-xl font-bold text-slate-900 group-hover:text-blue-600 transition-colors dark:text-white">Are all reference sources peer-reviewed medical journals?</span>
                        ...
                        <div x-show="open" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 -translate-y-4" x-transition:enter-end="opacity-100 translate-y-0" class="px-10 pb-8">
                            <p class="text-slate-600 leading-relaxed font-medium dark:text-slate-400">Yes. We source all citations from reputable medical databases (e.g. PubMed, CINAHL, NCBI, and academic healthcare journals) in correct APA 7th edition formatting.</p>
                        </div>
                    </div>

                    <div x-data="{ open: false }" class="group bg-white border border-slate-200 rounded-[2rem] overflow-hidden transition-all duration-500 hover:border-blue-300 hover:shadow-xl dark:bg-slate-900 dark:border-slate-800/80">
                        <button x-on:click="open = !open" class="w-full px-10 py-8 flex items-center justify-between text-left focus:outline-none">
                            <span class="text-xl font-bold text-slate-900 group-hover:text-blue-600 transition-colors dark:text-white">Can you write custom patient diagnoses for nursing care plans?</span>
                            <div class="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center text-slate-400 transition-transform duration-500 dark:bg-slate-950" :class="open ? 'rotate-180 bg-blue-600 text-white' : ''">
                                <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>
                            </div>
                        </button>
                        <div x-show="open" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 -translate-y-4" x-transition:enter-end="opacity-100 translate-y-0" class="px-10 pb-8">
                            <p class="text-slate-600 leading-relaxed font-medium dark:text-slate-400">Yes. Our tutors structure complete NANDA-style nursing care plans including clinical assessments data, interventions, scientific rationales, and evaluation criteria.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div class="max-w-4xl mx-auto text-center">
                    <h2 class="text-4xl sm:text-5xl font-black text-white leading-tight mb-5">
                        Get Your Nursing Care Plans<br>
                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400">Drafted Correctly Today</span>
                    </h2>
                    <p class="text-base text-slate-400 max-w-2xl mx-auto mb-10">
                        Submit clinical guidelines and receive Turnitin originality reports.
                    </p>
                    <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <a href="{{ route('order') }}" class="group relative inline-flex items-center gap-3 px-8 py-4 bg-blue-600 text-white font-black rounded-2xl hover:bg-white hover:text-blue-600 transition-all duration-500 shadow-[0_10px_30px_-10px_rgba(37,99,235,0.5)] hover:shadow-2xl hover:-translate-y-0.5 active:scale-95 overflow-hidden">
                            <span class="relative z-10 text-sm">Solve Patient Guidelines</span>
        ...
        <script type="application/ld+json">
        {
          ...
          "mainEntity": [
            {
              "@@type": "Question",
              "name": "Are all reference sources peer-reviewed medical journals?",
              "acceptedAnswer": {
                "@@type": "Answer",
                "text": "Yes. We source all citations from reputable medical databases (e.g. PubMed, CINAHL, NCBI, and academic healthcare journals) in correct APA 7th edition formatting."
              }
            },
            {
              "@@type": "Question",
              "name": "Can you write custom patient diagnoses for nursing care plans?",
              "acceptedAnswer": {
                "@@type": "Answer",
                "text": "Yes. Our tutors structure complete NANDA-style nursing care plans including clinical assessments data, interventions, scientific rationales, and evaluation criteria."
              }
            }
          ]
        }
