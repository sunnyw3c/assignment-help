...
@section('content')
    ...
    <header class="relative overflow-hidden bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50" role="banner">
        ...
        <div class="relative z-10 container mx-auto px-4 py-20 lg:py-32">
            <div class="text-center max-w-5xl mx-auto">
                <!-- Status Badge -->
                <div class="inline-flex items-center bg-gradient-to-r from-green-500 to-emerald-500 text-white px-6 py-3 rounded-full text-sm font-semibold mb-8 shadow-lg">
                ...
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
                    Complete <br>
                    <span class="bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">Programming & Assignment</span> <br>
                    Help Services
                </h1>

                <!-- Subtitle -->
                <p class="text-xl text-gray-600 mb-10 leading-relaxed max-w-4xl mx-auto">
                    From complex coding projects to academic writing assignments. Get professional help with web development, mobile apps, machine learning, essays, research papers, and more. All in one place.
                </p>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
                    <div class="bg-white/80 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-gray-100">
                        <div class="text-2xl font-bold text-purple-600 mb-1">{{ count($programmingServices) + count($assignmentServices) }}+</div>
    ...
    <section id="programming-services" class="py-24 bg-white relative overflow-hidden" role="main" aria-labelledby="programming-services-heading">
        <div class="container mx-auto px-4 relative z-10">
            ...
            <div class="text-center mb-16">
                ...
                <h2 id="programming-services-heading" class="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                ...
                <div class="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 overflow-hidden border border-gray-100">
                    <div class="p-8">
                        ...
                        <div class="flex items-start mb-4">
                            <div class="w-14 h-14 bg-gradient-to-br from-purple-500 to-blue-500 rounded-xl flex items-center justify-center mr-4 group-hover:scale-110 transition-transform duration-300">
                                <span class="text-3xl">{{ $service['icon'] }}</span>
                            </div>
                            <div class="flex-1">
                                <h3 class="text-xl font-bold text-gray-900 mb-1">{{ $service['name'] }}</h3>
                                <p class="text-sm text-purple-600 font-semibold">{{ $service['price_from'] }}+ • {{ $service['turnaround'] }}</p>
                            </div>
                        </div>
    ...
    <section id="assignment-services" class="py-24 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 relative overflow-hidden" aria-labelledby="assignment-services-heading">
        <div class="container mx-auto px-4 relative z-10">
            <!-- Section Header -->
            <div class="text-center mb-16">
                ...
                <h2 id="assignment-services-heading" class="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                    Academic Writing <br>
                    <span class="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Help & Assistance</span>
                </h2>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-6">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
                ...
                <div class="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 overflow-hidden border border-gray-100">
                    <div class="p-8">
                        <!-- Icon & Title -->
                        <div class="flex items-start mb-4">
                            <div class="w-14 h-14 bg-gradient-to-br from-blue-500 to-purple-500 rounded-xl flex items-center justify-center mr-4 group-hover:scale-110 transition-transform duration-300">
                                <span class="text-3xl">{{ $service->icon }}</span>
                            </div>
                            <div class="flex-1">
                                <h3 class="text-xl font-bold text-gray-900 mb-1">{{ $service->name }}</h3>
                                <p class="text-sm text-blue-600 font-semibold">${{ $service->base_price_per_page }}/page • {{ $service->turnaround_time }}</p>
                            </div>
                        </div>
        ...
        <div class="container mx-auto px-4">
            <div class="text-center mb-16">
                <h2 class="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                    Why Choose <span class="bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">Our Services</span>
                </h2>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
                <div class="text-center">
                    <div class="w-20 h-20 bg-gradient-to-br from-purple-500 to-blue-500 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg">
                ...
                <div class="text-center">
                    <div class="w-20 h-20 bg-gradient-to-br from-green-500 to-emerald-500 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg">
                        <span class="text-4xl">💯</span>
                    </div>
    ...
    <section class="py-20 bg-gradient-to-r from-purple-600 to-blue-600">
        <div class="container mx-auto px-4 text-center">
            ...
            <p class="text-xl text-purple-100 mb-10 max-w-3xl mx-auto">
                Join thousands of students and professionals who trust our services for their programming and academic needs.
            </p>
