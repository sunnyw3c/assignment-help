        ...
        function testimonialShowcase() {
            return {
                ...
                testimonials: [
                    ...
                    { initials: 'CB', color: 'linear-gradient(135deg, #06b6d4, #0891b2)', orb1: 'rgba(6,182,212,0.15)', orb2: 'rgba(8,145,178,0.1)', name: 'Chris B.', university: 'Penn State University', rating: 5, service: 'Homework Help', text: 'This service is amazing. I am getting my all assignments done with perfection. My grade has improved significantly and I am doing well in the class. A million thanks.' },
                    ...
                    { initials: 'JS', color: 'linear-gradient(135deg, #ef4444, #dc2626)', orb1: 'rgba(239,68,68,0.15)', orb2: 'rgba(220,38,38,0.1)', name: 'Jason S.', university: 'UNC Chapel Hill', rating: 5, service: 'Lab Report', text: 'I am really grateful to my friend who recommended me this platform. They are amazing. Kudos to all.' }
                ],
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="max-w-4xl mx-auto text-center mb-24">
                <div class="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white shadow-sm border border-slate-200 mb-8 dark:bg-slate-900 dark:border-slate-800/80">
                    ...
                    <span class="text-slate-900 font-black text-[10px] uppercase tracking-[0.2em] dark:text-white">Comprehensive Academic Assistance</span>
                </div>
    ...
    <section id="how-it-works" class="py-24 bg-gradient-to-br from-slate-800 via-indigo-950 to-slate-900 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="text-center mt-24">
                <a href="{{ route('order') }}"
                    class="group relative inline-flex items-center gap-3 px-10 py-5 bg-white dark:bg-indigo-600 rounded-full text-indigo-950 dark:text-white font-bold text-lg hover:bg-indigo-50 dark:hover:bg-indigo-500 transition-all duration-300 hover:scale-105 active:scale-95 shadow-[0_0_40px_-10px_rgba(255,255,255,0.3)]">
                ...
                <p class="mt-6 text-slate-500 text-sm dark:text-slate-400">No credit card required for quote</p>
            </div>
        </div>
    </section>
