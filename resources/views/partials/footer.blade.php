        ...
        <div class="flex flex-col lg:flex-row justify-between gap-12 lg:gap-8">
            ...
            <div class="flex flex-col gap-4 max-w-sm">
                ...
                <div class="flex items-center gap-3">
                    <a href="https://www.facebook.com/assignmenthelp.fb" target="_blank" rel="noopener noreferrer" aria-label="Follow us on Facebook"
                       class="inline-flex items-center justify-center w-9 h-9 rounded-full bg-slate-200 dark:bg-slate-900 text-slate-600 dark:text-slate-400 hover:bg-[#1877F2] hover:text-white transition-colors">
            ...
            <div class="flex flex-col sm:flex-row gap-10 sm:gap-16">
                ...
                <div class="flex flex-col gap-4 min-w-[150px]">
                    ...
                    <div class="flex flex-col gap-2.5 text-sm font-medium">
                        ...
                        <a href="{{ route('pricing') }}" class="hover:text-indigo-600 dark:hover:text-white transition-colors">Pricing</a>
