...
@section('title', 'Get Programming Help from Professional Coders Online')
@section('description', 'We provide professional yet affordable programming help online designed for college and university students to help them achieve their goals.')
                ...
                <div class="space-y-5 text-slate-400 text-[15px] leading-relaxed">
                    <div class="p-6 rounded-2xl bg-white/[0.03] border border-white/5">
                        <h3 class="text-lg font-bold text-white mb-3 flex items-center gap-2">
                            ...
                            Vetted Programming Experts, Not Random Freelancers
                        </h3>
                        <p>Every programming expert on our platform undergoes a structured vetting process that may include technical assessments, interviews, and qualification verification. When you request programming help online, you receive guidance from a specialist with experience in your programming language, framework, or technical topic.</p>
                    </div>
                    <div class="p-6 rounded-2xl bg-white/[0.03] border border-white/5">
                        <h3 class="text-lg font-bold text-white mb-3 flex items-center gap-2">
