                ...
                <div class="max-w-2xl mx-auto animate-fade-in-up animation-delay-600">
                    <div class="relative">
                        <input type="text"
                               ...
                               class="w-full px-6 py-5 rounded-2xl text-gray-900 text-lg focus:outline-none focus:ring-4 focus:ring-blue-400 shadow-xl dark:text-white"
                               x-data
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="mb-16">
                <div class="text-center mb-12">
                    <h2 class="text-3xl font-black text-gray-900 mb-4 dark:text-white">Browse by Category</h2>
                    <p class="text-lg text-gray-600 dark:text-slate-400">Select a category to jump to relevant questions</p>
                </div>

                <div class="flex flex-wrap justify-center gap-4">
                    @foreach($faqCategories as $index => $category)
                        <a href="#category-{{ $index }}"
                           class="group flex items-center bg-white hover:bg-gradient-to-r @if($category['color'] == 'blue') hover:from-blue-500 hover:to-blue-600 @elseif($category['color'] == 'green') hover:from-green-500 hover:to-green-600 @elseif($category['color'] == 'purple') hover:from-purple-500 hover:to-purple-600 @elseif($category['color'] == 'orange') hover:from-orange-500 hover:to-orange-600 @elseif($category['color'] == 'indigo') hover:from-indigo-500 hover:to-indigo-600 @else hover:from-pink-500 hover:to-pink-600 @endif px-6 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 border-2 border-gray-200 dark:bg-slate-900 dark:border-slate-800/80">
                            <span class="text-2xl mr-3 group-hover:scale-110 transition-transform">{{ $category['icon'] }}</span>
                            <span class="font-bold text-gray-900 group-hover:text-white transition-colors dark:text-white">{{ $category['name'] }}</span>
                        </a>
                    @endforeach
                </div>
            </div>
                                ...
                                <div class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border-2 @if($category['color'] == 'blue') border-blue-100 hover:border-blue-300 @elseif($category['color'] == 'green') border-green-100 hover:border-green-300 @elseif($category['color'] == 'purple') border-purple-100 hover:border-purple-300 @elseif($category['color'] == 'orange') border-orange-100 hover:border-orange-300 @elseif($category['color'] == 'indigo') border-indigo-100 hover:border-indigo-300 @else border-pink-100 hover:border-pink-300 @endif dark:bg-slate-900 dark:border-blue-900/50 dark:border-purple-900/50 dark:border-orange-900/50">
                                    <button x-on:click="open = !open"
                                        ...
                                        <div class="flex items-center flex-1">
                                            ...
                                            <h3 class="text-lg md:text-xl font-bold text-gray-900 dark:text-white" data-faq-question>{{ $faq['question'] }}</h3>
                                        </div>
                                        <svg x-bind:class="open ? 'rotate-180' : ''"
                                             class="w-6 h-6 @if($category['color'] == 'blue') text-blue-500 @elseif($category['color'] == 'green') text-green-500 @elseif($category['color'] == 'purple') text-purple-500 @elseif($category['color'] == 'orange') text-orange-500 @elseif($category['color'] == 'indigo') text-indigo-500 @else text-pink-500 @endif transition-transform duration-300 flex-shrink-0 ml-4"
                                    ...
                                    <div x-show="open"
                                         ...
                                         class="px-8 pb-6 border-t border-gray-100 dark:border-slate-800/80">
                                        <div class="pl-16 pt-6">
                                            <div class="bg-gradient-to-br @if($category['color'] == 'blue') from-blue-50 to-white @elseif($category['color'] == 'green') from-green-50 to-white @elseif($category['color'] == 'purple') from-purple-50 to-white @elseif($category['color'] == 'orange') from-orange-50 to-white @elseif($category['color'] == 'indigo') from-indigo-50 to-white @else from-pink-50 to-white @endif rounded-2xl p-6 border-2 @if($category['color'] == 'blue') border-blue-100 @elseif($category['color'] == 'green') border-green-100 @elseif($category['color'] == 'purple') border-purple-100 @elseif($category['color'] == 'orange') border-orange-100 @elseif($category['color'] == 'indigo') border-indigo-100 @else border-pink-100 @endif dark:to-slate-900 dark:border-blue-900/50 dark:border-purple-900/50 dark:border-orange-900/50">
                                                <div class="flex items-start">
                                                    <div class="w-8 h-8 bg-gradient-to-br @if($category['color'] == 'blue') from-blue-500 to-blue-600 @elseif($category['color'] == 'green') from-green-500 to-green-600 @elseif($category['color'] == 'purple') from-purple-500 to-purple-600 @elseif($category['color'] == 'orange') from-orange-500 to-orange-600 @elseif($category['color'] == 'indigo') from-indigo-500 to-indigo-600 @else from-pink-500 to-pink-600 @endif rounded-full flex items-center justify-center mr-4 flex-shrink-0 mt-1">
                                                        <span class="text-white font-bold">A</span>
                                                    </div>
                                                    <p class="text-gray-700 leading-relaxed text-lg dark:text-slate-300" data-faq-answer>{{ $faq['answer'] }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <div class="grid md:grid-cols-3 gap-8 mb-12">
                    <!-- Live Chat -->
                    <div class="bg-gradient-to-br from-blue-50 to-white rounded-3xl p-8 shadow-lg border-2 border-blue-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 dark:to-slate-900 dark:border-blue-900/50">
                        ...
                        <h3 class="text-2xl font-black text-gray-900 mb-3 dark:text-white">Live Chat</h3>
                        <p class="text-gray-600 mb-4 dark:text-slate-400">Chat with our support team in real-time</p>
                        <div class="text-sm text-blue-600 font-semibold">Average response: 2 min</div>
                    </div>

                    <!-- Email Support -->
                    <div class="bg-gradient-to-br from-purple-50 to-white rounded-3xl p-8 shadow-lg border-2 border-purple-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 dark:to-slate-900 dark:border-purple-900/50">
                        ...
                        <h3 class="text-2xl font-black text-gray-900 mb-3 dark:text-white">Email Support</h3>
                        <p class="text-gray-600 mb-4 dark:text-slate-400">Send us an email anytime</p>
                    ...
                    <!-- Phone Support -->
                    <div class="bg-gradient-to-br from-green-50 to-white rounded-3xl p-8 shadow-lg border-2 border-green-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 dark:to-slate-900">
                        ...
                        <h3 class="text-2xl font-black text-gray-900 mb-3 dark:text-white">Phone Support</h3>
                        <p class="text-gray-600 mb-4 dark:text-slate-400">Call us for immediate assistance</p>
