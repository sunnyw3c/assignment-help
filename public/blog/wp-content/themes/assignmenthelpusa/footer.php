        ...
        <div class="flex flex-col lg:flex-row justify-between gap-12 lg:gap-8">
            ...
            <div class="flex flex-col gap-4 max-w-sm">
                <a href="http://assignmenthelpusa.test">
                    <img src="http://assignmenthelpusa.test/images/logo.png" alt="Assignment Help USA" class="h-10 w-auto">
                </a>
            ...
            <div class="flex flex-col sm:flex-row gap-10 sm:gap-16">
                ...
                <div class="flex flex-col gap-4 min-w-[150px]">
                    ...
                    <div class="flex flex-col gap-2.5 text-sm font-medium">
                        <a href="http://assignmenthelpusa.test/about" class="hover:text-indigo-600 dark:hover:text-white transition-colors">About Us</a>
                        <a href="http://assignmenthelpusa.test/how-it-works" class="hover:text-indigo-600 dark:hover:text-white transition-colors">How It Works</a>
                        <a href="http://assignmenthelpusa.test/experts" class="hover:text-indigo-600 dark:hover:text-white transition-colors">Our Experts</a>
                    </div>
                </div>
