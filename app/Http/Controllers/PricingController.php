...
class PricingController extends Controller
{
    public function index()
    {
        ...
        $plans = [
            [
                'name' => 'Basic',
                'tagline' => 'Great for straightforward, everyday assignments',
                'price' => 25,
                'unit' => 'per page',
                'icon' => '📄',
                'accent' => 'blue',
                ...
                'features' => [
                    ['text' => 'High school & undergraduate level', 'included' => true],
                    ['text' => 'Standard delivery (3–5 days)', 'included' => true],
                    ['text' => 'Plagiarism-free, written from scratch', 'included' => true],
                    ['text' => 'Free plagiarism report', 'included' => true],
                    ['text' => 'Unlimited free revisions', 'included' => true],
                    ['text' => 'Direct chat with your expert', 'included' => false],
                    ['text' => 'Priority expert matching', 'included' => false],
                ],
            ],
            [
                'name' => 'Standard',
                'tagline' => 'Our most popular plan for college & masters work',
                'price' => 35,
                'unit' => 'per page',
                'icon' => '⭐',
                'accent' => 'indigo',
                ...
                'features' => [
                    ...
                    ['text' => 'Undergraduate & masters level', 'included' => true],
                    ...
                    ['text' => 'Dedicated PhD-level reviewer', 'included' => false],
                ],
            ],
            [
                'name' => 'Premium',
                'tagline' => 'Top-tier experts for theses, dissertations & PhD work',
                'price' => 50,
                'unit' => 'per page',
                'icon' => '👑',
                'accent' => 'purple',
                ...
                'features' => [
                    ...
                    ['text' => 'Masters & PhD level', 'included' => true],
                    ['text' => 'Express delivery (24–48 hours)', 'included' => true],
                    ['text' => 'Top 1% subject-matter experts', 'included' => true],
                    ['text' => 'Dedicated PhD-level reviewer', 'included' => true],
                    ['text' => 'Turnitin-verified quality audit', 'included' => true],
                    ['text' => 'Priority 24/7 support line', 'included' => true],
                ],
            ],
        ];
